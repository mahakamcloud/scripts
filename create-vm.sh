...
IMAGE=$DIR/ubuntu-18.04-server-cloudimg-amd64.img
...
ssh_authorized_keys:
  - ssh-rsa ssh-rsa  root@svr16
_EOF_
    ...
    bridge=virbr0,model=virtio --os-type=linux --os-variant=ubuntu1804 --noautoconsole"
